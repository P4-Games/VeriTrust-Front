...
import { veritrustFactoryAddressGoerli } from "@/constants/contracts/index";

export const ALCHEMY_API_KEY = "ybGQr_yqjMQV4RHXO_Z2BR8K5TuUwbER";
export const ALCHEMY_API_URL =
  "https://eth-goerli.g.alchemy.com/v2/ybGQr_yqjMQV4RHXO_Z2BR8K5TuUwbER";
export const CONTRACT_ADDRESS = veritrustFactoryAddressGoerli;
...
export const getTXFromLS = (hash: string): TransactionDetails | null => {
  ...
  const transaction = transactions.find(
    (t: TransactionDetails) => t.hash === hash
  );
...
export const listTransactions = async (
  ...
  setTenders: React.Dispatch<React.SetStateAction<TransactionDetails[]>>
) => {
